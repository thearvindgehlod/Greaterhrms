...
class _ShiftRequestPageState extends State<ShiftRequestPage>
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      Future.wait<void>([
        ...
        print('Error loading shift request data: $e');
        return [];
      });
    });
  }
  ...
  void approveRejectChecks() async {
    ...
    var employeeId = prefs.getInt("employee_id");
    var uri = Uri.parse(
        '$typedServerUrl/api/base/shift-request-approve-permission-check/$employeeId');
    var response = await http.get(uri, headers: {
      "Content-Type": "application/json",
      "Authorization": "Bearer $token",
    });
            ...
            child: Row(
              ...
              children: [
                ...
                Container(
                    ...
                    child: Visibility(
                      visible:
                          isCreateButtonVisible, // Set visibility based on your bool value
                      child: ElevatedButton(
                        onPressed: () {
                          setState(() {
                            _errorMessage = null;
