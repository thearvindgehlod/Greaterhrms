...
import 'package:Greaterchange/employee_views/rotating_shift.dart';
import 'package:Greaterchange/employee_views/rotating_work_type.dart';
import 'package:Greaterchange/employee_views/shift_request.dart';
import 'package:Greaterchange/employee_views/work_type_request.dart';
  ...
  Future<void> getWorkTypeRequest() async {
    ...
    for (var page = 1;; page++) {
      ...
      if (response.statusCode == 200) {
        ...
        print(
            'Failed to load work type requests. Status: ${response.statusCode}');
        break;
      }
    }
  ...
  Future<void> getRotatingWorkTypeRequest() async {
    ...
    for (var page = 1;; page++) {
      ...
      if (response.statusCode == 200) {
        ...
        print(
            'Failed to fetch rotating work type requests: ${response.statusCode}');
        break;
      }
    }
